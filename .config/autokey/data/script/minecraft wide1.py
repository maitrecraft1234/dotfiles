...
zoom_w = 1920 # Change this to the width you want Minecraft to be in after Tall Resolution is toggled on.
zoom_h = 300 # Do not change this unless you know what you are doing.
zoom_x = 1920 # Change this to the x coordinate you want Minecraft to go to when Tall Resolution is toggled on.
